      ...
      <form className="profile-card" onSubmit={handleSubmit}>
        <div className="profile-header">
          <div>
            ...
            <p>
              Help us personalize your IdeaSpark experience with a few quick
              details.
            </p>
          </div>
            ...
            <div className="chip-grid">
              {domainOptions.map((domain) => (
                <button
                  ...
                  type="button"
                  className={`chip ${
                    formData.interests.includes(domain) ? "active" : ""
                  }`}
          ...
          <div className="chip-grid">
            {lookingForOptions.map((option) => (
              <button
                ...
                type="button"
                className={`chip ${
                  formData.lookingFor.includes(option) ? "active" : ""
                }`}
          ...
          <div className="chip-grid">
            {availabilityOptions.map((option) => (
              <button
                ...
                type="button"
                className={`chip ${
                  formData.availability === option ? "active" : ""
                }`}
                onClick={() =>
